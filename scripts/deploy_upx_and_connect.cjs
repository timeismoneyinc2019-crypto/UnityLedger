...
async function deployUPX() {
  ...
  console.log("🔑 Contract address saved to .env as UNITY_TOKEN_CONTRACT");

  return contractAddress;
}

async function connectDashboard(contractAddress) {
  console.log("💻 Connecting UnityPay dashboard to UPX token...");
...
`;
  ...
  console.log("✅ Shared config updated:", configPath);
  ...
  console.log("🎉 UnityPay dashboard is now connected to UPX token.");
